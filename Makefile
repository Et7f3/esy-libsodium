...
ACLOCAL = ${SHELL} /tmp/esy-libsodium/build-aux/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /tmp/esy-libsodium/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/esy-libsodium/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/esy-libsodium/build-aux/missing automake-1.15
AWK = gawk
CC = gcc
CCAS = gcc
...
CFLAGS = -g -O2 -pthread -fvisibility=hidden -fno-strict-aliasing -fno-strict-overflow -fno-asynchronous-unwind-tables -ftls-model=local-dynamic
CFLAGS_AESNI = -maes
CFLAGS_AVX = -mavx
CFLAGS_AVX2 = -mavx2
...
CWFLAGS = -g -O2 -pthread -fvisibility=hidden -fno-strict-aliasing -fno-strict-overflow -fno-asynchronous-unwind-tables -Wextra -Wbad-function-cast -Wcast-qual -Wdiv-by-zero -Wduplicated-branches -Wduplicated-cond -Wfloat-equal -Wformat=2 -Wlogical-op -Wmaybe-uninitialized -Wmisleading-indentation -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-type-limits -Wno-unknown-pragmas -Wnormalized=id -Wnull-dereference -Wold-style-declaration -Wpointer-arith -Wredundant-decls -Wrestrict -Wstrict-prototypes -Wswitch-enum -Wwrite-strings
CYGPATH_W = cygpath -w
DEFS = -DPACKAGE_NAME=\"libsodium\" -DPACKAGE_TARNAME=\"libsodium\" -DPACKAGE_VERSION=\"1.0.18\" -DPACKAGE_STRING=\"libsodium\ 1.0.18\" -DPACKAGE_BUGREPORT=\"https://github.com/jedisct1/libsodium/issues\" -DPACKAGE_URL=\"https://github.com/jedisct1/libsodium\" -DPACKAGE=\"libsodium\" -DVERSION=\"1.0.18\" -DHAVE_PTHREAD=1 -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -D__EXTENSIONS__=1 -D_ALL_SOURCE=1 -D_GNU_SOURCE=1 -D_POSIX_PTHREAD_SEMANTICS=1 -D_TANDEM_SOURCE=1 -DHAVE_C_VARARRAYS=1 -DHAVE_CATCHABLE_SEGV=1 -DHAVE_CATCHABLE_ABRT=1 -DTLS=_Thread_local -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DHAVE_MMINTRIN_H=1 -DHAVE_EMMINTRIN_H=1 -DHAVE_PMMINTRIN_H=1 -DHAVE_TMMINTRIN_H=1 -DHAVE_SMMINTRIN_H=1 -DHAVE_AVXINTRIN_H=1 -DHAVE_AVX2INTRIN_H=1 -DHAVE_AVX512FINTRIN_H=1 -DHAVE_WMMINTRIN_H=1 -DHAVE_RDRAND=1 -DHAVE_SYS_MMAN_H=1 -DHAVE_SYS_RANDOM_H=1 -DHAVE_INTRIN_H=1 -DHAVE__XGETBV=1 -DNATIVE_LITTLE_ENDIAN=1 -DHAVE_INLINE_ASM=1 -DHAVE_CPUID=1 -DCPU_UNALIGNED_ACCESS=1 -DHAVE_ATOMIC_OPS=1 -DHAVE_ALLOCA_H=1 -DHAVE_ALLOCA=1 -DHAVE_ARC4RANDOM=1 -DHAVE_ARC4RANDOM_BUF=1 -DHAVE_MMAP=1 -DHAVE_MLOCK=1 -DHAVE_MADVISE=1 -DHAVE_MPROTECT=1 -DHAVE_GETRANDOM=1 -DHAVE_GETENTROPY=1 -DHAVE_POSIX_MEMALIGN=1 -DHAVE_GETPID=1 -DHAVE_NANOSLEEP=1 -DHAVE_EXPLICIT_BZERO=1 -DCONFIGURED=1
DEPDIR = .deps
DLLTOOL = dlltool
DLL_VERSION = 24
DSYMUTIL = 
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /tmp/esy-libsodium/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
VALGRIND_ENABLED = no
VERSION = 1.0.18
abs_builddir = /tmp/esy-libsodium
abs_srcdir = /tmp/esy-libsodium
abs_top_builddir = /tmp/esy-libsodium
abs_top_srcdir = /tmp/esy-libsodium
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /tmp/esy-libsodium/build-aux/install-sh
